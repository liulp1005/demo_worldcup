...
var dappAddress = "n1gefqT1Vn7vGaCEDBA2UmV8dG2ChSNDRKW";
...
export default class Say_count extends  React.Component{
    constructor(props){
      super(props)
    ...
    count(callback){
        ...
        //console.log("输出结果为 ："+ resp["result"])
        if(resp["result"] !=="null"){
            var respData = JSON.parse(resp["result"])  
            var key_Map = respData.key;
            vote_Map[key_Map] = parseInt(respData.value.length);
            //console.log("-----------------");
          //console.log(vote_Map);
        ...
        resultFot++;
        //console.log("resultFot: "  + resultFot);
